<template> 
  ...
  > 
    ...
    > 
      ...
      <RouterLink 
        to="/contact" 
        class="hidden lg:flex items-center justify-center px-6 py-3 rounded-full bg-gradient-to-r from-cyan-400 to-blue-600 text-white font-semibold transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_#22d3ee]" 
      > 
        Me contacter 
      </RouterLink> 
  ...
  <Transition name="sidebar"> 
    ...
    > 
      ...
      <RouterLink 
        to="/contact" 
        @click="menuOuvert = false" 
        class="absolute bottom-8 left-8 right-8 py-4 rounded-full bg-gradient-to-r from-cyan-400 to-blue-600 text-center text-white font-semibold transition-all duration-300 hover:shadow-[0_0_30px_#22d3ee]" 
      > 
        Me contacter 
      </RouterLink> 
